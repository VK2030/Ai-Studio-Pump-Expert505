...
const QUESTIONS = [
  {
    "matrix": {
      "r1": "СФ / КФ / АСПО / ВВЭ",
      "r2": "ЭЦН / ШГН",
      "r3": "Постоянное дозирование реагента (ингибитор солеотложений, ингибитор коррозии, бактерицид, ингибитор АСПО, деэмульгатор) в затруб скважины через СУДР",
      "r4": "Минимальное допустимое погружение насоса под Ндин? (метров)"
    },
    "text": "Постоянное дозирование реагента (ингибитор солеотложений, ингибитор коррозии, бактерицид, ингибитор АСПО, деэмульгатор) в затруб скважины через СУДР - Минимальное допустимое погружение насоса под Ндин? (метров)",
    "options": [
      "30",
      "50",
      "100",
  ...
  },
  {
    "matrix": {
      "r1": "СФ / КФ / АСПО / ВВЭ",
      "r2": "ЭЦН, ШГН",
      "r3": "Постоянное дозирование реагента (ингибитор солеотложений, ингибитор коррозии, бактерицид, ингибитор АСПО, деэмульгатор) в затруб скважины через СУДР по импульсной трубке",
      "r4": "Минимальное допустимое погружение насоса под Ндин? (метров)"
    },
    "text": "Постоянное дозирование реагента (ингибитор солеотложений, ингибитор коррозии, бактерицид, ингибитор АСПО, деэмульгатор) в затруб скважины через СУДР по импульсной трубке - Минимальное допустимое погружение насоса под Ндин? (метров)",
    "options": [
      "нет",
      "50",
      "100",
  ...
  {
    "matrix": {
      "r1": "СФ / КФ / АСПО / ГГО / ВВЭ",
      "r2": "ЭЦН / ШГН",
      "r3": "Постоянное дозировании реагента (ингибитор солеотложений, ингибитор коррозии, бактерицид, ингибитор АСПО, деэмульгатор) в затруб скважины через СУДР",
      "r4": "Максимально допустимый перепад давления (Рзат-Рлин) при открытой затрубной задвижке? (атм)"
    },
    "text": "Постоянное дозировании реагента (ингибитор солеотложений, ингибитор коррозии, бактерицид, ингибитор АСПО, деэмульгатор) в затруб скважины через СУДР - Максимально допустимый перепад давления (Рзат-Рлин) при открытой затрубной задвижке? (атм)",
    "options": [
      "3",
      "5",
      "10",
  ...
  },
  {
    "matrix": {
      "r1": "СФ / КФ / АСПО / ГГО / ВВЭ",
      "r2": "ЭЦН / ШГН",
      "r3": "Постоянное дозировании реагента (ингибитор солеотложений, ингибитор коррозии, бактерицид, ингибитор АСПО, деэмульгатор) в затруб скважины через СУДР по импульсной трубке",
      "r4": "Максимально допустимый перепад давления (Рзат-Рлин) при открытой затрубной задвижке? (атм)"
    },
    "text": "Постоянное дозировании реагента (ингибитор солеотложений, ингибитор коррозии, бактерицид, ингибитор АСПО, деэмульгатор) в затруб скважины через СУДР по импульсной трубке - Максимально допустимый перепад давления (Рзат-Рлин) при открытой затрубной задвижке? (атм)",
    "options": [
      "нет",
      "3",
      "5",
  ...
  },
  {
    "matrix": {
      "r1": "СФ / КФ / АСПО / ВВЭ",
      "r2": "ЭЦН / ШГН",
      "r3": "Постоянное дозировании реагентов в товарной форме (ингибиторов солеотложений, ингибиторов коррозии, бактерицида) в затруб скважины через СУДР",
      "r4": "Ограничение по минимальному Qжидкости? (м3/сут)"
    },
    "text": "Постоянное дозировании реагентов в товарной форме (ингибиторов солеотложений, ингибиторов коррозии, бактерицида) в затруб скважины через СУДР - Ограничение по минимальному Qжидкости? (м3/сут)",
    "options": [
      "5",
      "10",
      "50",
  ...
  },
  {
    "matrix": {
      "r1": "КФ",
      "r2": "ЭЦН / ШГН",
      "r3": "Постоянное дозирование ингибиторов коррозии в затруб скважины через СУДР",
      "r4": "Ограничение по максимальному Qжидкости ЭЦН? (м3/сут)"
    },
    "text": "Постоянное дозирование ингибиторов коррозии в затруб скважины через СУДР - Ограничение по максимальному Qжидкости ЭЦН? (м3/сут)",
    "options": [
      "100",
      "300",
      "500",
  ...
  },
  {
    "matrix": {
      ...
      "r2": "ЭЦН / ШГН",
      "r3": "Постоянное дозирование ингибиторов коррозии в затруб скважины через СУДР",
      "r4": "Ограничение по максимальному КВЧ? (мг/л)"
    },
    "text": "Постоянное дозирование ингибиторов коррозии в затруб скважины через СУДР - Ограничение по максимальному КВЧ? (мг/л)",
    "options": [
      "100",
      "300",
      "500",
  ...
  },
  {
    "matrix": {
      ...
      "r2": "ЭЦН / ШГН",
      "r3": "Постоянное дозирование ингибиторов коррозии в затруб скважины через СУДР",
      "r4": "Ограничение по максимальной Т пласта? (гр. Цельсия)"
    },
    "text": "Постоянное дозирование ингибиторов коррозии в затруб скважины через СУДР - Ограничение по максимальной Т пласта? (гр. Цельсия)",
    "options": [
      "60",
      "70",
      "80",
  ...
  },
  {
    "matrix": {
      "r1": "СФ / КФ / АСПО / ВВЭ",
      "r2": "ЭЦН / ШГН",
      "r3": "Периодическое дозирование реагентов (ингибиторов солеотложений, ингибиторов коррозии, бактерицидов, ингибиторов АСПО, деэмульгаторов) в затруб скважины через СУДР",
      "r4": "Минимальное допустимое погружение насоса под Ндин? (метров)"
    },
    "text": "Периодическое дозирование реагентов (ингибиторов солеотложений, ингибиторов коррозии, бактерицидов, ингибиторов АСПО, деэмульгаторов) в затруб скважины через СУДР - Минимальное допустимое погружение насоса под Ндин? (метров)",
    "options": [
      "30",
      "50",
      "100",
  ...
  },
  {
    ...
    "text": "Периодическое дозирование реагентов (ингибиторов солеотложений, ингибиторов коррозии, бактерицидов, ингибиторов АСПО, деэмульгаторов) в затруб скважины через СУДР - Максимально допустимый перепад давления (Рзат-Рлин) при открытой затрубной задвижке? (атм)",
    "options": [
      "3",
      "5",
      "8",
  ...
  },
  {
    "matrix": {
      "r1": "КФ",
      "r2": "ЭЦН / ШГН",
      "r3": "Периодическое дозирование ингибиторов коррозии в затруб скважины",
      "r4": "Ограничение по максимальному Qжидкости? (м3/сут)"
    },
    "text": "Периодическое дозирование ингибиторов коррозии в затруб скважины - Ограничение по максимальному Qжидкости? (м3/сут)",
    "options": [
      "100",
      "300",
      "500",
  ...
  },
  {
    ...
    "text": "Периодическое дозирование ингибиторов коррозии в затруб скважины - Ограничение по максимальному КВЧ? (мг/л)",
    "options": [
      "100",
      "300",
      "500",
  ...
  },
  {
    "matrix": {
      ...
      "r2": "ЭЦН / ШГН",
      "r3": "Периодическое дозирование ингибиторов коррозии в затруб скважины",
      "r4": "Ограничение по максимальному Т пласта? (гр. Цельсия)"
    },
    "text": "Периодическое дозирование ингибиторов коррозии в затруб скважины - Ограничение по максимальному Т пласта? (гр. Цельсия)",
    "options": [
      "60",
      "70",
      "80",
  ...
  },
  {
    "matrix": {
      "r1": "СФ / КФ / АСПО",
      "r2": "ЭЦН / ШГН",
      "r3": "Неуправляемый внутрискважинный контейнер с ингибитором (ИС, ИК, ИАСПО)",
      "r4": "Ограничение по максимальному Qжидкости?  (м3/сут)"
    },
    "text": "Неуправляемый внутрискважинный контейнер с ингибитором (ИС, ИК, ИАСПО) - Ограничение по максимальному Qжидкости?  (м3/сут)",
    "options": [
      "50",
      "75",
      "100",
  ...
  },
  {
    "matrix": {
      ...
      "r2": "ЭЦН / ШГН",
      "r3": "Неуправляемый внутрискважинный контейнер с ингибитором (ИС, ИК, ИАСПО)",
      "r4": "Максимальный период защиты? (суток)"
    },
    "text": "Неуправляемый внутрискважинный контейнер с ингибитором (ИС, ИК, ИАСПО) - Максимальный период защиты? (суток)",
    "options": [
      "60",
      "90",
      "180",
  ...
  },
  {
    "matrix": {
      "r1": "СФ / КФ / АСПО",
      "r2": "ЭЦН",
      "r3": "Управляемый внутрискважинный контейнер с ингибитором (ИС, ИК, ИАСПО)",
      "r4": "Ограничение по максимальной Т пласта?"
    },
    "text": "Управляемый внутрискважинный контейнер с ингибитором (ИС, ИК, ИАСПО) - Ограничение по максимальной Т пласта?",
    "options": [
      "60",
      "75",
      "80",
  ...
  },
  {
    ...
    "text": "Управляемый внутрискважинный контейнер с ингибитором (ИС, ИК, ИАСПО) - Максимальный период защиты? (суток)",
    "options": [
      "60",
      "90",
      "180",
  ...
  },
  {
    ...
    "text": "Управляемый внутрискважинный контейнер с ингибитором (ИС, ИК, ИАСПО) - Ограничение по максимальному Qжидкости? (м3/сут)",
    "options": [
      "50",
      "75",
      "100",
  ...
  },
  {
    "matrix": {
      "r1": "МП, ЭрФ",
      "r2": "ЭЦН",
      "r3": "Фильтр модульный гр. Ф-2, Ф-3, Ф-4",
      "r4": "Ограничение по максимальному Qжидкости ЭЦН ?  (м3/сут)"
    },
    "text": "Фильтр модульный гр. Ф-2, Ф-3, Ф-4 - Ограничение по максимальному Qжидкости ЭЦН ?  (м3/сут)",
    "options": [
      "200",
      "300",
      "400",
  ...
  },
  {
    "matrix": {
      "r1": "МП, ЭрФ",
      "r2": "ЭЦН",
      "r3": "Сепаратор мех.примесей для ГНО гр.Ф-5",
      "r4": "Ограничение по максимальному Qжидкости? (м3/сут)"
    },
    "text": "Сепаратор мех.примесей для ГНО гр.Ф-5 - Ограничение по максимальному Qжидкости? (м3/сут)",
    "options": [
      "500",
      "700",
      "900",
  ...
  },
  {
    ...
    "text": "Сепаратор мех.примесей для ГНО гр.Ф-5 - Ограничение по минимальному Qжидкости? (м3/сут)",
    "options": [
      "5",
      "10",
      "25",
  ...
  },
  {
    "matrix": {
      ...
      "r2": "ЭЦН",
      "r3": "Сепаратор мех.примесей для ГНО гр.Ф-5",
      "r4": "Ограничение по максимальному уголу наклона в месте размещения ГНО? (градусов)"
    },
    "text": "Сепаратор мех.примесей для ГНО гр.Ф-5 - Ограничение по максимальному уголу наклона в месте размещения ГНО? (градусов)",
    "options": [
      "40",
      "60",
      "70",
  ...
  },
  {
    "matrix": {
      "r1": "КФ / ЭрФ / АСПО / ГГО",
      "r2": "Все СЭ",
      "r3": "НКТ с внутренним покрытием Тип 1",
      "r4": "Ограничение по максимальной Т пласта? (гр. Цельсия)"
    },
    "text": "НКТ с внутренним покрытием Тип 1 - Ограничение по максимальной Т пласта? (гр. Цельсия)",
    "options": [
      "60",
      "80",
      "110",
  ...
  },
  {
    "matrix": {
      "r1": "КФ / ЭрФ / АСПО / ГГО",
      "r2": "Все СЭ",
      "r3": "НКТ с внутренним покрытием Тип 2",
      "r4": "Ограничение по максимальной Т пласта? (гр. Цельсия)"
    },
    "text": "НКТ с внутренним покрытием Тип 2 - Ограничение по максимальной Т пласта? (гр. Цельсия)",
    "options": [
      "60",
      "80",
      "110",
  ...
  },
  {
    "matrix": {
      "r1": "КФ / ЭрФ / АСПО / ГГО",
      "r2": "Все СЭ",
      "r3": "НКТ с внутренним покрытием Тип 3",
      "r4": "Ограничение по максимальной Т пласта? (гр. Цельсия)"
    },
    "text": "НКТ с внутренним покрытием Тип 3 - Ограничение по максимальной Т пласта? (гр. Цельсия)",
    "options": [
      "60",
      "80",
      "110",
  ...
  },
  {
    "matrix": {
      "r1": "СФ / КФ",
      "r2": "Капсулированный ИС, размещённый в ЗУМПФ скважины",
      "r3": "Минимальный ЗУМПФ для применения технологии? (метр)",
      "r4": "Ответы:"
    },
    "text": "Минимальный ЗУМПФ для применения технологии? (метр) - Ответы:",
    "options": [
      "10",
      "15",
      "20",
  ...
  },
  {
    "matrix": {
      "r1": "СФ / КФ",
      "r2": "Капсулированный ИС, размещённый в ЗУМПФ скважины",
      "r3": "Максимальная Т пласта для применения технологии? (гр. Цельсия)",
      "r4": "Ответы:"
    },
    "text": "Максимальная Т пласта для применения технологии? (гр. Цельсия) - Ответы:",
    "options": [
      "50",
      "60",
      "80",
  ...
  },
  {
    "matrix": {
      "r1": "АСПО / ГГО / ВВН",
      "r2": "Греющий кабель (с наружным креплением на НКТ или с внутренним расположением в НКТ)",
      "r3": "Максимальная Т пласта для применения греющего кабеля? (гр. Цельсия)",
      "r4": "Ответы:"
    },
    "text": "Максимальная Т пласта для применения греющего кабеля? (гр. Цельсия) - Ответы:",
    "options": [
      "110",
      "120",
      "130",
  ...
  },
  {
    "matrix": {
      "r1": "КФ / АСПО",
      "r2": "НКТ из стеклопластика вся подвеска",
      "r3": "Максимальная Т пласта для применения? (гр. Цельсия)",
      "r4": "Ответы:"
    },
    "text": "Максимальная Т пласта для применения? (гр. Цельсия) - Ответы:",
    "options": [
      "60",
      "70",
      "80",
  ...
  },
  {
    "matrix": {
      "r1": "ВГФ",
      "r2": "Конический УЭЦН",
      "r3": "Ограничение по максимальному содержанию свободного газа (%) в насосе?",
      "r4": "Ответы:"
    },
    "text": "Ограничение по максимальному содержанию свободного газа (%) в насосе? - Ответы:",
    "options": [
      "25",
      "30",
      "35",
      ...
      <div className="absolute top-8 left-0 right-0 flex justify-center px-4 pointer-events-none z-10">
         <div className={`p-4 rounded-xl max-w-lg w-full text-center shadow-lg border backdrop-blur-sm
           ${isDark ? 'bg-slate-800/80 border-slate-700/50' : 'bg-white/80 border-slate-200/50'}`}>
            ...
            {sessionQuestions[currentQuestionIdx]?.matrix ? (
              <div className="w-full mt-2 overflow-hidden rounded overflow-x-auto border border-[#475569] shadow-sm">
                <table className="w-full text-center border-collapse">
                  <tbody>
                    <tr className="border-b border-[#475569]">
                       <td className={`p-2 text-xs font-bold ${isDark ? 'text-slate-300' : 'text-slate-700'}`}>
                         {sessionQuestions[currentQuestionIdx].matrix.r1}
                       </td>
                    </tr>
                    <tr className="border-b border-[#475569]">
                       <td className={`p-2 text-xs font-bold ${isDark ? 'text-slate-300' : 'text-slate-700'}`}>
                         {sessionQuestions[currentQuestionIdx].matrix.r2}
                       </td>
                    </tr>
                    <tr className="border-b border-[#475569]">
                       <td className={`p-2 text-sm font-semibold ${isDark ? 'text-slate-200' : 'text-slate-800'}`}>
                         {sessionQuestions[currentQuestionIdx].matrix.r3}
                       </td>
                    </tr>
                    <tr>
                       <td className={`p-3 text-base font-black ${isDark ? 'text-white' : 'text-slate-900'}`}>
                         {sessionQuestions[currentQuestionIdx].matrix.r4}
                       </td>
                    </tr>
                  </tbody>
                </table>
