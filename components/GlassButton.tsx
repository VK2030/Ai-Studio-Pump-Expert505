      ...
      case 'calc':
        return (
          <div className={iconWrapperClass}>
             ...
             <svg viewBox="0 0 24 24" className="w-full h-full text-indigo-300 drop-shadow-[0_0_8px_rgba(165,180,252,0.4)]" fill="none" stroke="currentColor" strokeWidth="1.5">
      ...
      case 'pump':
        return (
          <div className={iconWrapperClass}>
            ...
            <svg viewBox="0 0 24 24" className="w-full h-full text-indigo-200" fill="none" stroke="currentColor" strokeWidth="1.5">
      ...
      case 'search':
        return (
          <div className={iconWrapperClass}>
            ...
            <svg viewBox="0 0 24 24" className="w-full h-full text-indigo-300" fill="none" stroke="currentColor" strokeWidth="1.5">
  ...
  return (
    <button 
      ...
      className="group relative flex flex-col items-start p-4 pb-10 rounded-[1.5rem] border border-white/10 overflow-hidden transition-all duration-300
                 ...
                 hover:bg-white/[0.08] hover:border-indigo-500/40
                 active:scale-[0.97]"
    >
      ...
      <div className="absolute bottom-3 left-4 right-4 z-10">
        <div className="flex justify-between items-center mb-1">
          <span className="text-[8px] uppercase font-black text-indigo-400/60 tracking-wider">Прогресс</span>
